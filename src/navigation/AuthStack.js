...
//
// Auth screens (Login / Register / ForgotPin) are presented as modals on top
// of the main app, so unauthenticated users can browse and only see the
// login prompt when they tap "Log in" or try to do something that requires
// authentication.
